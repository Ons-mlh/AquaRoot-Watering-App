    ...
    return (
        <> 
                <div className='relative w-fit-content'>
                    <img src={cactusIcon} alt="cactus icon" className=" size-10 md:size-15 absolute animate-bounce top-120 left-80 md:left-350 md:top-90 opacity-40 "/>
                    <img src={flowerIcon} alt="flower icon" className="size-15 md:size-20 absolute animate-bounce bottom-100 left-5 md:left-50 md:top-15 opacity-40 "/>
